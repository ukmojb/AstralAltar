package com.wdcftgg.astralaltar.cilent.effect;

import com.wdcftgg.astralaltar.cilent.tile.NewStructureMatchPreview;
...
public final class NewEffectHandler {

    public static final Random STATIC_EFFECT_RAND = new Random();
    public static final NewEffectHandler instance = new NewEffectHandler();
    ...
    private NewStructureMatchPreview structurePreview = null;
    ...
    private NewEffectHandler() {}

    public static NewEffectHandler getInstance() {
        return instance;
    }
    ...
    public void requestStructurePreviewFor(TileEntity tile) {
    ...
    public void onDebugText(RenderGameOverlayEvent.Text event) {
        if(Minecraft.getMinecraft().gameSettings.showDebugInfo) {
            event.getLeft().add("");
            event.getLeft().add(TextFormatting.BLUE + "[AstralAltar]" + TextFormatting.RESET + " Use Local persistent data: " + PersistentDataManager.INSTANCE.usePersistent());
            event.getLeft().add(TextFormatting.BLUE + "[AstralAltar]" + TextFormatting.RESET + " NewEffectHandler:");
            event.getLeft().add(TextFormatting.BLUE + "[AstralAltar]" + TextFormatting.RESET + " > Complex effects: " + getDebugEffectCount());
        }
    }
